...
func TestSanitizeUpstreamURL(t *testing.T) {
	...
	cases := []struct {
		...
		{"https with path-embedded key", "https://ultra-falling-snow.quiknode.pro/ee9a3908bde3f1c71a2f20047143da49a99a37f8/", "https://ultra-falling-snow.quiknode.pro"},
...
func TestStatusAPI_UpstreamsEndpointDoesNotLeakURLCredentials(t *testing.T) {
	...
	yaml := fmt.Sprintf("logLevel: error\n"+
		...
		"    upstreams:\n"+
		"      - id: u1\n"+
		"        url: \"https://ultra-falling-snow.quiknode.pro/ee9a3908bde3f1c71a2f20047143da49a99a37f8/\"\n"+
		"    routing:\n"+
	...
	if upstreams[0].URL != "https://ultra-falling-snow.quiknode.pro" {
